...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 882.5, 168.5, 50.0, 25.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 841.0, 88.0, 102.0, 25.0 ],
					"style" : "",
					"text" : "unpack 0. 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 841.0, 40.0, 89.0, 25.0 ],
					"style" : "",
					"text" : "r /HandRight"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 665.0, 271.0, 32.5, 25.0 ],
					"style" : "",
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 665.0, 234.0, 79.0, 25.0 ],
					"style" : "",
					"text" : "delay 1000"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 665.0, 193.0, 49.0, 25.0 ],
					"style" : "",
					"text" : "t b b 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 665.0, 109.5, 42.0, 25.0 ],
					"style" : "",
					"text" : "> 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 665.0, 55.0, 61.0, 25.0 ],
					"style" : "",
					"text" : "gate 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 444.0, 109.5, 38.0, 25.0 ],
					"style" : "",
					"text" : "+ 60"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 444.0, 67.5, 77.0, 25.0 ],
					"style" : "",
					"text" : "random 24"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 665.0, 156.0, 40.0, 25.0 ],
					"style" : "",
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 499.0, 417.5, 137.0, 25.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 499.0, 508.5, 93.0, 25.0 ],
					"style" : "",
					"text" : "s delayTimeL"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 499.0, 470.5, 46.0, 25.0 ],
					"style" : "",
					"text" : "$1 30"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 736.0, 417.5, 173.0, 146.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 94.0, 109.5, 235.0, 150.0 ],
					"viewvisibility" : 1
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "delayBP.maxpat",
				"bootpath" : "C:/Users/michael/Downloads/UBCToolbox_1.01/Modules/Effects/delay",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "delay.maxpat",
				"bootpath" : "C:/Users/michael/Downloads/UBCToolbox_1.01/Modules/Effects/delay/lib",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
